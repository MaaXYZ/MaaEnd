...
| --- | --- | --- | --- | --- | --- |
| H1 | 删除死的阈值 JSON 配置入口链 | 未进行 | B1 | — | — |
| H2 | 删除 `parsePriceLimitValue`（随 H1，无独立提交） | 未进行 | B1 | — | — |
...
| 提交 | 内容 | 短 hash |
| --- | --- | --- |
| 基线文档提交 | 本计划 + `autostockpile-redundancy-audit.md`（6.7 确认纳入版本控制） | — |
| 状态同步提交 | 本文件回填上述 hash 与 §6.9 确认记录 | — |
